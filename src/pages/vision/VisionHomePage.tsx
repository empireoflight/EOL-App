...
import { useConvergenceSession, useMyPendingVisionSession, useOpenVisionSession } from '../../hooks/useConvergenceSession'
...
// hits "Start a vision session" and spawns a redundant parallel one).
function OpenSessionBanner({ teamId }: { teamId: string | undefined }) {
...
export default function VisionHomePage() {
  ...
  if (!vision) {
    return (
      <div className="mx-auto flex max-w-xl flex-col gap-5 px-6 py-10">
        ...
        <OpenSessionBanner teamId={teamId} />
        {!openSession && (
          <Card>
            <div className="flex items-center justify-between gap-4">
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-8 px-6 py-10">
      ...
      {vision.status !== 'pending_commitment' && <OpenSessionBanner teamId={teamId} />}
